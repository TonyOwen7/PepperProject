...
def rechercher_wikipedia(question, langue="fr"):
    ...
    try:
        ...
        return {"source": "Wikipedia", "text": "Aucune information pertinente trouvée."}

    except Exception as e:
        return {"source": "Wikipedia", "text": f"Erreur lors de la récupération des informations : {e}"}
...
def rechercher_wikihow(question):
    try:
        ...
        return {"source": "WikiHow", "text": f"Erreur lors de la récupération des informations : {e}"}
